...
function Gift() {
  ...
  return (
    ...
    <div className="gift-container">
      ...
      <h2 className="gift-heading">Dompet Digital</h2>
      <p className="gift-description">
      Doa Bapak/Ibu merupakan hadiah yang sangat berarti bagi kami. Dan jika memberi merupakan ungkapan cinta, Anda dapat memberikan hadiah dengan mengirimkan amplop digital.
      </p>
