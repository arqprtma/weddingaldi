...
function Header() {
  return (
    <>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#4D0D1E" fillOpacity="1" d="M0,320L120,304C240,288,480,256,720,256C960,256,1200,288,1320,304L1440,320L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"></path></svg>
    </>
  );
}
